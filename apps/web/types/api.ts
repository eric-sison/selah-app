...
export interface paths {
    ...
    "/api/lineups/{id}": {
        ...
        /**
         * Update a lineup
         * @description Admin-only. Updates a lineup's team assignment, series/topic, word, and/or direction. Use the songs/members endpoints to change the set list or roster.
         */
