...
export type LiveWaveformProps = HTMLAttributes<HTMLDivElement> & {
  ...
  processing?: boolean
  deviceId?: string
  // Visualize an existing AnalyserNode (e.g. tapped off an <audio> element)
  // instead of requesting a microphone stream via getUserMedia.
...
export const LiveWaveform = ({
  ...
  // When an external analyser is supplied, use it directly instead of
  // requesting a microphone - the caller owns that node's lifecycle (e.g. an
  // AudioContext tied to a shared <audio> element), so this effect must not
  // tear it down.
  useEffect(() => {
  ...
  }, [active, analyserNode, deviceId, fftSize, smoothingTimeConstant, onError, onStreamReady, onStreamEnd])
